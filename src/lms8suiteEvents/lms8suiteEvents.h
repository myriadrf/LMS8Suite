#ifndef LMS8SUITE_EVENT_IDS_H
#define LMS8SUITE_EVENT_IDS_H

#include <wx/wx.h>

wxDECLARE_EVENT(CONTROL_PORT_CONNECTED, wxCommandEvent);
wxDECLARE_EVENT(LMS7_CONTROL_PORT_CONNECTED, wxCommandEvent);
wxDECLARE_EVENT(DATA_PORT_CONNECTED, wxCommandEvent);
wxDECLARE_EVENT(CONTROL_PORT_DISCONNECTED, wxCommandEvent);
wxDECLARE_EVENT(LMS7_CONTROL_PORT_DISCONNECTED, wxCommandEvent);
...
wxDECLARE_EVENT(LMS8_TXBAND_CHANGED, wxCommandEvent);
wxDECLARE_EVENT(LMS8_RXPATH_CHANGED, wxCommandEvent);
